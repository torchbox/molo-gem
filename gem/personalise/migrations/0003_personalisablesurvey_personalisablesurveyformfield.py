# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2017-05-17 17:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('segment', modelcluster.fields.ParentalKey(blank=True, help_text='Leave it empty to show this field to every user.', null=True, on_delete=django.db.models.deletion.PROTECT, to='personalisation.Segment')),
            ],
            options={
